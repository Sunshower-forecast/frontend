...
const width = '300px';
const height = '100px';
const gradient = (baseColour, centerPoint, angle) => {
  return `radial-gradient(at 0 20%, ${baseColour}) 0, rgba(255,255,255,0.3) 31%, rgba(255,255,255,0) 100%)`;
}

const gradent = `radial-gradient(at 0 10%, rgba(180,180,180,0.9) 0, rgba(180,180,180,0.8) 11%, rgba(255,255,255,0.6) 21%, rgba(255,255,255,0.3) 31%, rgba(255,255,255,0) 100%)`;
